...
function convertOptionsToCmdArgs(options) {
  ...
  Object.entries(options).forEach(function (_ref) {
    ...
    var hasValue = value !== undefined || value !== null || value !== false;
    if (hasValue) args.push("--" + key);

    if (hasValue && value !== true && value != null && value.toString()) {
      args.push(value == null ? void 0 : value.toString());
    }
  }, true);
  return args;
}
var optionConverterMap = {
  ...
  awbgains: function awbgains(_ref4) {
    var val1 = _ref4[0],
        val2 = _ref4[1];
    return val1 + "," + val2;
  },
  roi: function roi(_ref5) {
    var x = _ref5.x,
        y = _ref5.y,
        w = _ref5.w,
        h = _ref5.h;
...
export { jpeg, libcamera, raw, still, vid };
